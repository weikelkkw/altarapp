          ...
          {studyLoading && !studyText && (
            <div className="flex flex-col items-center justify-center flex-1 gap-4">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center"><img src="/read book.png" alt="" style={{ width: 40, height: 40, objectFit: 'contain' }} /></div>
              </div>
              ...
              {!askLoading && (
                <div className="px-5 pb-5 pt-1" style={{ borderTop: `1px solid ${accentColor}08` }}>
                  <button
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}><img src="/read book.png" alt="" style={{ width: 40, height: 40, objectFit: 'contain' }} /> Go Deeper on This Topic</span>
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="rounded-2xl overflow-hidden" style={{ background: `linear-gradient(145deg, ${accentColor}08, rgba(0,0,0,0.15))`, border: `1px solid ${accentColor}18` }}>
              ...
              <div className="px-6 pb-5">
                <button
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}><img src="/read book.png" alt="" style={{ width: 40, height: 40, objectFit: 'contain' }} /> Deep Study This Passage</span>
                </button>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              {!aiLoading && aiResults.length > 1 && (
                <button
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}><img src="/read book.png" alt="" style={{ width: 40, height: 40, objectFit: 'contain' }} /> Study These {aiResults.length} Verses Together</span>
                </button>
              )}
                        ...
                        <div style={{ borderTop: `1px solid ${accentColor}10` }}>
                          ...
                          <div className="px-5 pb-3" style={{ borderTop: `1px solid ${accentColor}08` }}>
                            <button
                              ...
                              style={{ background: `${accentColor}12`, color: accentColor, border: `1px solid ${accentColor}22` }}>
                              <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}><img src="/read book.png" alt="" style={{ width: 40, height: 40, objectFit: 'contain' }} /> Deep Study This Verse</span>
                            </button>
                          </div>
